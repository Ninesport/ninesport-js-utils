...
import { calculateTotalStakeAndMaxPayout } from "../src/combination-bet"
...
describe("calculateTotalStakeAndMaxPayout", () => {
    ...
    const systemBetOptionId = "4" // System 2/3 (Doubles)
    ...
    it("should correctly calculate for a system bet (e.g., System 2/3)", () => {
        const inputs = [
            {
                perStakeAmount: "10",
                combinationBetOptionId: systemBetOptionId, // System 2/3
                odds: ["1.5", "2.0", "3.0"],
            },
        ]
